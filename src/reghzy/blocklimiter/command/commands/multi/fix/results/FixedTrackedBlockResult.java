...
public class FixedTrackedBlockResult extends BlockLookupResult {
    ...
    private final TrackedBlock block;
    private final String nbtOwner;
    private final int id;
    private final int data;

    public FixedTrackedBlockResult(@Nonnull TrackedBlock block, @Nonnull TileEntity tileEntity, @Nonnull BlockLimiter limiter, @Nonnull MetaLimiter metaLimit, @Nullable String nbtOwner) {
